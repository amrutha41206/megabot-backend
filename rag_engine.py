...
class RAGEngine:
        ...
        while len(self.documents) > self.max_documents_per_session:
            ...
            if oldest_doc in self.documents:
                ...
                if file_path and os.path.exists(file_path):
                    os.remove(file_path)
                    print(f"🗑️ Deleted old file: {oldest_doc}")
    ...
    def load_pdf(self, file_path, doc_name="document"):
        ...
        with self.upload_lock:
            ...
            embeddings = self.embed_texts(chunks, task_type="retrieval_document")
    ...
    def is_relevant(self, scores):
        ...
        print(f"📈 Max relevance score: {max_score:.3f} | Threshold: {self.relevance_threshold}")
